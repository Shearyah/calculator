...
set rc [catch {
  ...
  import_db {../syn_1/calculator_gate.db}
  place
  export_db {calculator_place.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  route
  report_area -io_info -file calculator_phy.area
  export_db {calculator_pr.db}
} RESULT]
if {$rc} {
...
set rc [catch {
  export_bid calculator_inst.bid
  bitgen -bit "calculator.bit"
} RESULT]
if {$rc} {
  step_error bitgen
  return -code error $RESULT
